...
```sh
npm install git+ssh://git@github.com:rsata/giphy-sdk-ts-test.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/rsata/giphy-sdk-ts-test/issues) with questions, bugs, or suggestions.
