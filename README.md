...
[![NPM version](https://img.shields.io/npm/v/giphy.svg)](https://npmjs.org/package/giphy) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/giphy)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/giphy-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install giphy`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/giphy-typescript/issues) with questions, bugs, or suggestions.
